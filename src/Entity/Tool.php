...
class Tool implements JsonSerializable {
  ...
  private ?float $sertifikat = null;

  #[ORM\Column(nullable: true)]
  private ?float $duzina = null;
  ...
  public function getSertifikat(): ?float {
    return $this->sertifikat;
  }

  public function setSertifikat(?float $sertifikat): self {
    $this->sertifikat = $sertifikat;

    return $this;
  }

  public function getDuzina(): ?float {
    return $this->duzina;
  }

  public function setDuzina(?float $duzina): self {
    $this->duzina = $duzina;
