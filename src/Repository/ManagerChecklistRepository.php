...
class ManagerChecklistRepository extends ServiceEntityRepository {
    ...
    public function save(ManagerChecklist $checklist): ManagerChecklist {
        ...
        if (!is_null($checklist->getPhase())) {

            $this->getEntityManager()->getRepository(Phase::class)->calculatePhaseEfficiency($checklist->getPhase());
        }
...
//    });
    ...
    public function remove(ManagerChecklist $entity): void {
        ...
        if (!is_null($phase)) {
            ...
            $this->getEntityManager()->getRepository(Phase::class)->calculatePhaseEfficiency($phase);
        }
    }
    ...
    public function countTasksPhase(Phase $phase): array {
        $qb = $this->createQueryBuilder('t');
        ...
        return [$totalCount, $verifyCount];

    }

    public function getTasksByProjectPhasePaginator($filterBy, User $user, Project $project, Phase $phase, $admin): QueryBuilder {
...
//    $endDate = $today->sub(new DateInterval('P1D')); // Trenutni datum
        ...
        $qb->where('c.project = :projekat');
        $qb->setParameter('projekat', $project);
        $qb->andWhere('c.phase = :phase');
...
//<!--  }-->
//<!---->
//<!--  public function getTasksByProjectPaginator($filterBy, User $user, Project $project, $admin): \Doctrine\ORM\QueryBuilder {-->
//<!--    $company = $project->getCompany();-->
//<!--    $today = new DateTimeImmutable(); // Dohvati trenutni datum i vrijeme-->
//<!--//    $endDate = $today->sub(new DateInterval('P1D')); // Trenutni datum-->
//<!--    $endDate = $today; // Trenutni datum-->
...
//<!--    $this->getEntityManager()->remove($entity);-->
//<!--    $this->getEntityManager()->flush();-->
//<!--    if (!is_null($entity->getPhase())) {-->
//<!--      $this->getEntityManager()->getRepository(Phase::class)->calculatePhaseEfficiency($entity->getPhase());-->
//<!--    }-->
//<!---->
//<!--  }-->
//<!---->
